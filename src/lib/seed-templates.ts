 ...
 * seed-templates.ts
 * 
 * 10 templates de posts LinkedIn pré-configurés pour le seeding.
 * Utilisable via l'API /api/post-templates/seed ou directement dans le code.
 */
...
export const SEED_TEMPLATES: SeedTemplate[] = [
  {
    ...
    description:
      'Structure narrative captivante avec une leçon à la fin',
  ...
  },
  {
    ...
    category: 'listicle',
    description:
      'Article structuré en liste avec conseils pratiques',
  ...
  },
  {
    ...
    category: 'engagement',
    description:
      'Question provocatrice pour stimuler les interactions',
  ...
  },
  {
    ...
    description:
      'Témoignage client avec résultats mesurables',
  ...
  },
  {
    ...
    description:
      'Réflexion personnelle authentique et inspirante',
  ...
  },
  {
    ...
    category: 'engagement',
    description:
      'Opinion stimulante avec nuances et respect',
  ...
  },
  {
    ...
    category: 'howto',
    description:
      'Guide pratique avec étapes claires',
  ...
  },
  {
    ...
    category: 'personal',
    description:
      'Citation impactante avec réflexion personnelle',
  ...
  },
  {
    ...
    category: 'promotional',
    description:
      'Lancement produit/service avec enthousiasme',
  ...
  },
  {
    ...
    category: 'personal',
    description:
      'Pensée personnelle du matin, authentique et réflexive',
